...
import numpy as np
import pandas as pd
from plot_functions import emissions_plot, power_plot  # <-- updated import
...
def main():
    ...
    for scen in scenarios:
        ...
        # Load power from the COPIED location
    ...
    # 8) Write metadata for this run, including all scenarios' run_settings.yml
